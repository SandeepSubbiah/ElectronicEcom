...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "Sandeep.alumni@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Sandeep Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Sandeep Electronics.<br>"
					...
					+ "<span class='greenText'>Sandeep500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
